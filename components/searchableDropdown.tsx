...
export function SearchableDropdown({options, onOptionSelected}) {
  ...
  const onOptionPress = (option) => {
    console.log("onOptionPress PRESSED");
...
// function SearchableDropDownV2(props: SearchableItemProps) {
  
//   const parseItem = (item : defaultItem) => {
//     let onPress;
//     if (props.selectedItems.filter((seitem) => item.id == seitem.id).length === 0) {
//       onPress = props.onRemoveItem(item, item.id);
//     } else {
//       onPress = props.onItemSelect(item, item.id);
//     }

//     return (<TouchableOpacity style={[styles.itemStyle, {flex: 1, flexDirection: 'row' }]}>
//       <View style={{ flex: 0.9, flexDirection: 'row', alignItems: 'flex-start' }}>
//         <Text>{ item.name }</Text>
//       </View>
//       <View style={{ flex: 0.1, flexDirection: 'row', alignItems: 'flex-end' }}>
//         <TouchableOpacity onPress={onPress} style={{ backgroundColor: '#f16d6b', alignItems: 'center', justifyContent: 'center', width: 25, height: 25, borderRadius: 100, marginLeft: 10}}>
//           <Text>X</Text>
//         </TouchableOpacity>
//       </View>
//     </TouchableOpacity>);
...
//  class SearchableDropDownV1 extends Component {
//   constructor(props) {
//     super(props);
